export default function AboutPage() {
    return (<div style={{ maxWidth: "800px" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
        ...
        ].map(item => (<div key={item.badge} style={{ display: "flex", gap: "0.75rem", alignItems: "flex-start", background: "#0d1117", borderRadius: "0.5rem", padding: "0.875rem" }}>
        ...
        ].map(([label, source]) => (<div key={label} style={{ display: "flex", justifyContent: "space-between", padding: "0.5rem 0", borderBottom: "1px solid #1f2937" }}>
        ...
        ].map(([name, contact, url]) => (<div key={name} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0.5rem 0", borderBottom: "1px solid #1f2937", flexWrap: "wrap", gap: "0.25rem" }}>
                <a href={url} target="_blank" rel="noopener noreferrer" style={{ color: "#006BB6", fontSize: "0.875rem", textDecoration: "none" }} onMouseEnter={e => (e.currentTarget.style.color = "#F58426")} onMouseLeave={e => (e.currentTarget.style.color = "#006BB6")}>{name}</a>
...
function Section({ title, children }) {
    return (<div style={{ background: "#111827", border: "1px solid #1f2937", borderRadius: "0.75rem", padding: "1.5rem" }}>
