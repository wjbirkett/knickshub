export default function TwitterFeed({ handle = "nyknicks", height = 500 }) {
    ...
    return (<div style={{ borderRadius: "0.75rem", overflow: "hidden", border: "1px solid #1f2937", background: "#111827" }}>
      ...
      <iframe src={src} style={{ width: "100%", height: `${height}px`, border: "none", display: "block", background: "#111827" }} title={`@${handle} on X`} sandbox="allow-same-origin allow-scripts allow-popups allow-popups-to-escape-sandbox"/>
    </div>);
}
