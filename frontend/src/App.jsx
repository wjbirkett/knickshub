...
export default function App() {
    return (<HelmetProvider>
      <BrowserRouter>
        ...
        ].map(({ label, to }) => (<Link key={to} to={to} style={{ color: "#4b5563", fontSize: "0.75rem", textDecoration: "none" }} onMouseEnter={e => (e.currentTarget.style.color = "#F58426")} onMouseLeave={e => (e.currentTarget.style.color = "#4b5563")}>{label}</Link>))}
